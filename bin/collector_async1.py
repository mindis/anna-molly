...
def main(args, options):
    ...
    try:
        aerospike_writer = getattr(sink, options.metricstore_connector)({ "hosts": [ ( '127.0.0.1', 3000 ) ], "policies": { "timeout": 1000 } })
    ...
    try:
        listener_config = {'spout':{'carbon':{'host': "0.0.0.0", 'port': 2004}}}
